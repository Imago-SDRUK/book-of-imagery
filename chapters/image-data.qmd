...
![Satellite imagery resolution types.](images/satellite_imagery resolution_types.png){#fig-imagery_resolution_types width=80%}
...
![](images/land_cover_UK_2024.png){#fig:land_cover width="80%" fig-cap="Satellite derived land cover map for UK, 2024. Source: UK Centre for Ecology and Hydrology (https://www.ceh.ac.uk/data/ukceh-land-cover-maps)"}
