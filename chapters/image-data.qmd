...
::: {.column-margin .callout-warning title ="Review comment"}
SP: I took a shot at expanding this in response to the comment above. 
__________________________________
"Social scientists and policy makers think about resolution all the time — they just don't call it that. When choosing data, they constantly ask: what scale of analysis matches my question? @carozzi2016sending studied transfers to Italian municipalities using both city-level data and information on individual politicians — a choice about spatial and administrative granularity driven by their question. @pana2021country analyzed COVID-19 causalities using country-level aggregates because national determinants was their focus. The fundamental question driving these choices is always: *what level of detail do I need to answer my research question?*

Satellite imagery works the same way. "Resolution" is simply the satellite equivalent of choosing your unit of analysis. Just as a researcher decides whether to work with individual, neighborhood, city, or country-level data, satellite users must choose imagery that matches the scale of the social or environmental processes they want to observe.""
:::
...
------------------------------------------------------------------------
[MVP: I know that I put a comment on resolution in the previous chapter, I see here you expand more which is great but I still believe we need in the previous chapter to explain what is very high or coarse or etc....To keep everyone under the same level. ]{.mark} 
...
::: {.column-margin .callout-warning title="Review comment"}
SP: What if we describe some examples of these bands e.g. have a box describing the 13 bands for Sentinel?
:::
...
[MVP: To be honest I like that this section is a bit more technical, but I agree with DAB's comment that it needs to be tweaked towards social scientists. If we have more illustrations that can help too perhaps.]{.mark}
