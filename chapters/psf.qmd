...
@fig-cloud shows our derived annual cloud probability using surface reflectance imagery from Sentinel-2. It reveals the spatial pattern of established meteorological expectations. Upland areas like the Pennines and Scottish Highlands show higher cloud probability, while coastal regions—particularly along the south and east—experience clearer skies. This gradient reflects the British Isles' geographies, where moist air masses rise over elevated terrain and condense, creating persistent cloud cover over Britain's mountainous spine, and sunny spots along the southern coasts.


![**Annual cloud probability across local super output areas, 2024, United Kingdom**. *Source: Created by the Data Service for Imagery - Imago using Sentinel-2 Level-2A Bottom-of-Atmosphere (BOA) surface reflectance imagery, Collection 1, accessed via [Element84 Earth Search STAC API](https://earth-search.aws.element84.com/v1)* ](images/spf-chp/cloud_prob_map_BoI.png){#fig-cloud width="300"}
